...
<head>
	...
	<title>net2mobi.com, creating mobile sites</title>
...
<!-- A tab to launch the Classic Widget -->
    ...
    <div id="container">            
            <div id="tete">
            	<div id="logo">
                    <a href="<?php echo base_url(); ?>index.php/net2mobi">                        
      ...
      <footer id="piedPage"> 
          <i>This a only demo version of net2mobi cms, please dowload source to get your own.</i>
      </footer> 
